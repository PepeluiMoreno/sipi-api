...
# ============================================================
# SCRIPT DE GENERACIÓN DE MIXINS Y MODELOS MEJORADOS
# Ejecutar desde la raíz del proyecto
# ============================================================

echo "🚀 Creando estructura de mixins y modelos..."
...
from .agentes import (
    ...
    ColegioProfesional, Diocesis, Notaria, NotariaTitular,
...
echo "✅ ESTUCTURA CREADA EXITOSAMENTE"
echo ""
echo "📁 Estructura creada:"
echo "   app/db/mixins/"
echo "   ├── __init__.py"
echo "   ├── base.py"
echo "   ├── identificacion.py"
echo "   ├── direccion.py"
echo "   ├── contacto.py"
echo "   └── titularidad.py"
echo ""
...
echo "   ├── documentos.py"
echo "   ├── actuaciones.py"
echo "   ├── transmisiones.py"
echo "   ├── inmuebles.py"
echo "   ├── agentes.py"
echo "   ├── historiografia.py"
echo "   ├── proteccion.py"
echo "   ├── subvenciones.py"
echo "   └── users.py"
echo ""
echo "🎯 Próximos pasos:"
echo "   1. Revisa los archivos generados"
echo "   2. Ajusta las rutas de importación si es necesario"
echo "   3. Ejecuta alembic revision --autogenerate"
echo "   4. Revisa la migración antes de aplicarla"
